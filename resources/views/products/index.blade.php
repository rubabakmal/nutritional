				...
				<tr>
					...
					<td class="py-3">
						<div class="position-relative">
							<a class="link-dark d-inline-block" href="{{ route('product.show', $product) }}" title="View">
								<i class="gd-eye icon-text"></i>
							</a>
							<a class="link-dark d-inline-block" href="{{ route('product.edit', $product) }}" title="Edit">
