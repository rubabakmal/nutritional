    ...
    <div class="card mb-3 mb-md-4">
        ...
        <div class="card-body">
            ...
            <div class="mb-3 mb-md-4 d-flex justify-content-between">
                ...
                <a href="{{ route('user.create') }}" class="btn btn-primary shop-now-btn">
                    Add new
                </a>
            </div>
                                    ...
                                    <div class="position-relative">
                                        ...
                                        @if ($user->id != auth()->user()->id)
                                            <a class="link-dark d-inline-block" href="#"
                                                onclick="if(confirm('Delete this record?')){document.getElementById('delete-entity-{{ $user->id }}').submit();return false;}">
